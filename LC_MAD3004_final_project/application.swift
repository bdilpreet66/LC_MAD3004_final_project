...
class Application {
    ...
    init () {
        ...
        store = [
            ...
            StockHolding(name: "D", price: 10.0, p_price: 8.0, holding: 5),
        ...
        store.add(ForeignStockHolding(name: "M", price: 10.0, p_price: 8.0, holding: 5, rate: 1.2))
    }
    ...
    func sortArray() {
//        let newArr = self.store.sort(using: [NSSortDescriptor(key: "name", ascending: true)])
//        print(newArr)
    }
